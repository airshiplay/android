 ...
 * @version 1.0.0
 */
public class PullToRefreshListView4 extends ListView{
    ...
    public PullToRefreshListView4(Context context){
        super(context);
        init();
    }

    public PullToRefreshListView4(Context context, AttributeSet attrs){
        super(context, attrs);
        init();
    }

    public PullToRefreshListView4(Context context, AttributeSet attrs, int defStyle){
